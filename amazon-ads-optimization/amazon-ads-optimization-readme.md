# 📸 Amazon Ads AI Optimization — Visual Tour
...
![01-LandingPage](./screenshots/01-LandingPage.png)
...
**Layer 2 — AI Agent:** Runs on flagged keywords only. Two sequential LLM calls (Claude Sonnet — chosen for its reasoning quality on multi-factor business decisions):

> The AI pipeline layer is built on the same architecture as the [Atom Process Engine](../atom-process-engine) — three-layer separation, markdown-driven step definitions, schema validation at each boundary, and immutable audit logging. The codebase was copied directly rather than referenced as a package, so both projects are self-contained.

- **LLM Call 1** — For each flagged keyword, the model evaluates the context and produces a decision (`ACT` / `HOLD` / `ESCALATE`), a one-line brief, full reasoning, and a confidence score.
- **LLM Call 2** — Aggregates all per-keyword decisions into a final campaign recommendation with new bid values and an overall confidence score (floor of all Call 1 scores).

In Normal Mode, the model reasons purely on keyword metrics and the `is_main_keyword` flag — no external context is injected.
...
![03-ActiveKW-NormalMode-KWAIAnalysis-Atom1](./screenshots/03-ActiveKW-NormalMode-KWAIAnalysis-Atom1.png)
...
![03-ActiveKW-NormalMode-KWAIAnalysis-Atom2](./screenshots/03-ActiveKW-NormalMode-KWAIAnalysis-Atom2.png)
...
![03.1-ActiveKW-NormalMode-KWAIAnalysis-Result](./screenshots/03.1-ActiveKW-NormalMode-KWAIAnalysis-Result.png)
...
![04-ActiveKW-NormalMode-KWAIAnalysis-ResultDetails](./screenshots/04-ActiveKW-NormalMode-KWAIAnalysis-ResultDetails.png)
...
![05-ActiveKW-ScenarioMode](./screenshots/05-ActiveKW-ScenarioMode.png)
...
![05.1-ActiveKW-ScenarioMode-KWAIAnalysis](./screenshots/05.1-ActiveKW-ScenarioMode-KWAIAnalysis.png)
...
![07-InactiveKW-Clickhouse](./screenshots/07-InactiveKW-Clickhouse.png)
...
![08-InactiveKW-NormalMode-KWRevive](./screenshots/08-InactiveKW-NormalMode-KWRevive.png)
...
![09-InactiveKW-ScenarioMode-UpcomingEventToggled](./screenshots/09-InactiveKW-ScenarioMode-UpcomingEventToggled.png)
...
![17-AIListingAnalysis-Result1](./screenshots/17-AIListingAnalysis-Result1.png)
...
![18-AIListingAnalysis-Result2](./screenshots/18-AIListingAnalysis-Result2.png)
...
![12-AIAnalysisHistory-KWAnalysis](./screenshots/12-AIAnalysisHistory-KWAnalysis.png)
...
![13-AIAnalysisHistory-ListingAnalysis](./screenshots/13-AIAnalysisHistory-ListingAnalysis.png)
...
![14-AIAnalysisHistory-AnalysisDetailPage](./screenshots/14-AIAnalysisHistory-AnalysisDetailPage.png)
...
![15-AIAnalysisHistory-AnalysisDetailPage-InputOutputJson](./screenshots/15-AIAnalysisHistory-AnalysisDetailPage-InputOutputJson.png)
...
![10-RuleEngine](./screenshots/10-RuleEngine.png)
...
![11-RuleDetails](./screenshots/11-RuleDetails.png)
...
![19-ProcessInspector-Prompt](./screenshots/19-ProcessInspector-Prompt.png)
...
![20-ProcessInspector-IOSchema](./screenshots/20-ProcessInspector-IOSchema.png)
...
![21-ProcessInspector-Process](./screenshots/21-ProcessInspector-Process.png)
